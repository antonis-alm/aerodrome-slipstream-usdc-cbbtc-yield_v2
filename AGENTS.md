# AerodromeSlipstreamUsdcCbbtcYieldStrategy - Agent Guide

> AI coding agent context for the `aerodrome_slipstream_usdc_cbbtc_yield` strategy.

## Overview

- **Template:** dynamic_lp
- **Chain:** base
- **Class:** `AerodromeSlipstreamUsdcCbbtcYieldStrategy` in `strategy.py`
- **Config:** `config.json`
